...
app = Flask(__name__)
app.config['SECRET_KEY'] = 'flaskisawesome'
conn = ibm_db.connect("DATABASE=bludb;HOSTNAME=824dfd4d-99de-440d-9991-629c01b3832d.bs2io90l08kqb1od8lcg.databases.appdomain.cloud;PORT=30119;SECURITY=SSL;SSLServerCertificate=DigiCertGlobalRootCA.crt;UID=hgh01434;PWD=a5YsjGuZxcdsXkkj", '', '')
app.config['MAIL_SERVER'] = 'smtp.gmail.com'
app.config['MAIL_PORT'] = 465
app.config['MAIL_USERNAME'] = 'hanayah231@gmail.com'
app.config['MAIL_PASSWORD'] = 'qgewrsmkutkvyszx'
